...
## Overview
These are my portfolio and process for building up webpage. A key goal in my projects was to understand the developer's workflow, creating a user experience that simplified the process of turning business needs into programming logic.
